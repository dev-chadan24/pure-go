    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      ...
      >
        <div className="text-center space-y-4">
          ...
          <h1 className="text-2xl font-semibold tracking-tight mt-6">Welcome back</h1>
          <p className="text-sm text-muted-foreground font-light">Enter your credentials to continue</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-500">Forgot?</a>
            </div>
            <Input 
              id="password" 
              type="password" 
